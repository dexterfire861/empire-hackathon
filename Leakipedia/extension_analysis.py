...
from Leakipedia.config import ANTHROPIC_API_KEY, CLAUDE_MODEL
...
BROKER_DATA = {
    ...
    "beenverified.com": "https://www.beenverified.com/optout/",
    ...
    "intelius.com": "https://app.intelius.com/privacy-center/?",
...
def classify_site_type(hostname: str, payload: dict[str, Any], trackers: list[str], domain_age_days: Optional[int]) -> str:
...
def score_analysis(site_type: str, data_types: list[str], trackers: list[str], dark_patterns: list[str], policy_exists: bool, domain_age_days: Optional[int]) -> int:
    score = 8
...
def build_signals(site_type: str, data_types: list[str], trackers: list[str], policy_exists: bool, dark_patterns: list[str], domain_age_days: Optional[int], hostname: str, user_state: str) -> list[str]:
    signals: list[str] = []
    if data_types:
...
def lookup_domain_age_days(hostname: str) -> Optional[int]:
